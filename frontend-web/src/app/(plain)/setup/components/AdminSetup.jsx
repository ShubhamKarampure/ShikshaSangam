          ...
          <div className="col-md-8">
            <div className="card shadow-lg border-0">
              <div className="card-header bg-primary text-white position-relative py-4">
                ...
                <p className="mb-0 mt-1 text-white-50">Complete your college admin profile</p>
              </div>
              ...
              <div className="card-body p-4">
                <div className="btn-group w-100 mb-4" role="group">
                  ...
                  />
                  <label className="btn btn-outline-primary" htmlFor="adminInfo">
                  ...
                  <input
                    ...
                    disabled={!profileCreated}
                  />
                  <label className="btn btn-outline-primary" htmlFor="collegeInfo">
