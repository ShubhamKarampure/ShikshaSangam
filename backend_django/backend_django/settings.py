...
SECRET_KEY = "django-insecure-#ydr$v0k+(2f!0knx^-yyzfux03&3e&53=bf^gl276p9mkr_+#"
...
SITE_ID = 1  # This should match the ID of the site in the "Sites" framework.
LOGIN_REDIRECT_URL = '/'  # Redirect after successful login, to be changed accordingly
